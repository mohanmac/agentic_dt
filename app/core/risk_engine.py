...
@dataclass
class RiskConfig:
    max_capital_per_trade: float = 2000.0  # NOTIONAL CAP: a 1%-risk MIS position with a <10% stop needs >10% of capital deployed; cap at full capital (intraday MIS leverage). Loss is still bounded by per_trade_max_loss_absolute below.
